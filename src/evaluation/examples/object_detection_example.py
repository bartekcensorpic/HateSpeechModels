...
if __name__ == "__main__":
    ...
    # select folders
    GT_FOLDER = (
        r"C:\Users\barte\Desktop\trash\gt_folder"  # folder for ground truths .txt files
    )
    DET_FOLDER = r"C:\Users\barte\Desktop\trash\detections_folder"  # folder for detections .txt files
    OUTPUT_FOLDER = (
        r"C:\Users\barte\Desktop\trash\evaluator_results"  # folder for outputs
    )
    IOU_THRESHOLD = 0.3
    ...
    class_metrics, mAP, X_all, y_all = evaluator.calculate_mAP(
        IOU_THRESHOLD, OUTPUT_FOLDER
    )
    ...
    for class_data in class_metrics:
        ...
        (
            ...
            recall_full,
            thresholds_full,
        ) = binary_evaluation_result.get_precision_recall_thresholds()
        ...
        (
            ...
            f1_ths_ax,
        ) = binary_evaluation_result.get_f1_thresholds_and_plot()
