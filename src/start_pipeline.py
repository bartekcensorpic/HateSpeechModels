...
def start(dataset_path,root_save_path):
    ...
    model_map = {
        ...
        'mobilebert_transformers': get_mobilebert_transformers(train_X, train_y, test_X, test_y,root_save_path),
    }

    train_function, output_save_path  = model_map['mobilebert_transformers']
